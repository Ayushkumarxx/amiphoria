  ...
  return (
    <div className="flex justify-between items-center mt-4 flex-wrap">
      {teamMembers.map((member, index) => (
        <div
          key={index}
          className="flex flex-col w-[280px] h-[350px] overflow-hidden mb-[10px] max-md:w-[150px] max-md:h-[250px]"
        >
          <img
            src={member.image}
            alt={member.name}
          ...
          <div className="w-full flex flex-col p-2 justify-between items-end">
            <p className="text-[16px] max-md:text-[14px] font-bold text-black mt-2 max-md:mt-1">
              {member.role}
            </p>
            <p className="text-[22px] max-md:text-[18px] font-bold text-black">
              {member.name}
            </p>
          </div>
        </div>
  ...
  return (
    <section className="bg-[#F2ECE7] ">
      ...
      <section className="max-w-[1250px] mt-[50px] px-2.5 mx-auto flex justify-between items-center">
        ...
        >
          <div className="text-[142px] max-md:text-[38px] leading-none mb-2 font-bold max-xl:text-[124px]">
            MEET
          </div>
        ...
        >
          ...
          <div className="text-[142px] max-md:text-[38px] font-bold leading-none max-xl:text-[114px]">
            OUR TEAM
          </div>
        </motion.div>
      </section>
      ...
      <motion.section
        className="max-w-[1250px] mt-[50px] mx-auto pb-10 px-2.5"
        initial={{ opacity: 0, y: isMobile ? 20 : 30 }}
        animate={{ opacity: 1, y: 0 }}
